...
const beneficios = [
  {key: '1. Regular a temperatura corporal'},
  {key: '2. Combater acne, estrias e celulite'},
  {key: '3. Melhorar o funcionamento dos rins'},
  {key: '4. Prevenir o aparecimento de pedras nos rins'},
  {key: '5. Facilitar a digestão'},
  {key: '6. Diminuir o inchaço'},
  {key: '7. Melhorar a circulação sanguínea'},
  {key: '8. Ajudar a emagrecer'}
];
...
Meditar não é apenas sentar-se e concentrar-se, de vez em quando. É um árduo, disciplinado e diário caminho que inclui, sobretudo, estar atento e lúcido o tempo todo. Seja no trabalho, no lazer ou no descanso. A meditação real exige mente vigilante e compreende a totalidade da vida; sem exceção de fatos ou comportamentos: é o reto pensar e reto agir, para que aflore uma dimensão nova, primeiro na mente, depois na manifestação real."/>
      <Form/>
      <ComponentInfo1 titulo="Planeje seus exercícios físicos" autor="Autor Desconhecido" conteudo="O ideal é sempre intercalar os exercícios aeróbios com os de força, como musculação, mantendo também dias de descanso. O repouso é muito importante para recuperar o corpo e prevenir lesões. Já para não perder a motivação durante o treino, vale estabelecer metas de distância percorrida. Para mais dicas, acesse"/>
